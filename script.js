...
window.onload = () => {
    // Initialize Google Accounts Client AFTER page and all scripts (like gsi/client) have fully loaded
    if (typeof google === "undefined" || !google.accounts || !google.accounts.oauth2) {
        alert("Google API failed to load. Please check your internet connection or API script.");
        return;
    }
